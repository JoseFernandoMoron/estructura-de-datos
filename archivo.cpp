...
{
	cout<<endl<< "Introducir Gimnasio:";
	do{
		gets(reg->gimnasio);// reg.gimnasio --- reg->gimnasio 
...
{
	cout<<endl<< nroReg<<".-"<< reg.gimasio<< "         "<<reg.precio<< "    "<< reg.anillo;
}
...
void listarArchivo(char nomArch[15])
{
	...
	else
	{
		...
		cout<<endl<<" Gimnasio      Precio      Anillo";
		cout<<endl<<"----------------------------";
